angular.module('CaaMApp.file.ctrl', [])
  ...
  .controller('FileCtrl', function ($scope, $log, $cordovaFile) {
    ...
    $scope.checkDir = function () {
      document.addEventListener('deviceready', function () {
        // path, directory
        $cordovaFile.checkDir(cordova.file.externalRootDirectory, $scope.inputs.checkDir).then(function (success) {
    ...
    $scope.createDirectory = function () {
      document.addEventListener('deviceready', function () {
        ...
        $cordovaFile.createDir(cordova.file.externalRootDirectory, $scope.inputs.createDirectory, false).then(function (success) {
    ...
    $scope.createFile = function () {
      document.addEventListener('deviceready', function () {
        ...
        $cordovaFile.createFile(cordova.file.externalRootDirectory, $scope.inputs.createFile, true).then(function (success) {
    ...
    $scope.removeFile = function () {
      document.addEventListener('deviceready', function () {
        // path, fileName
        $cordovaFile.removeFile(cordova.file.externalRootDirectory, $scope.inputs.removeFile).then(function (success) {
    ...
    $scope.removeDirectory = function () {
      document.addEventListener('deviceready', function () {
        // path, dirName
        $cordovaFile.removeDir(cordova.file.externalRootDirectory, $scope.inputs.removeDirectory).then(function (success) {
    ...
    $scope.removeRecursively = function () {
      document.addEventListener('deviceready', function () {
        // path, dirName
        $cordovaFile.removeRecursively(cordova.file.externalRootDirectory, $scope.inputs.removeDirectory).then(function (success) {
    ...
    $scope.writeFile = function () {
      document.addEventListener('deviceready', function () {
        ...
        $cordovaFile.writeFile(cordova.file.externalRootDirectory, $scope.inputs.writeFile, $scope.inputs.writeText, true).then(function (success) {
    ...
    $scope.writeExistingFile = function () {
      document.addEventListener('deviceready', function () {
        // path, fileName, text
        $cordovaFile.writeExistingFile(cordova.file.externalRootDirectory, $scope.inputs.writeExistingFile, $scope.inputs.writeExistingText).then(function (success) {
    ...
    $scope.readFileAsText = function () {
      document.addEventListener('deviceready', function () {
        // path, fileName
        $cordovaFile.readAsText(cordova.file.externalRootDirectory, $scope.inputs.readFile).then(function (success) {
    ...
    $scope.moveDir = function () {
      document.addEventListener('deviceready', function () {
        ...
        $cordovaFile.moveDir(cordova.file.externalRootDirectory, $scope.inputs.moveDirectory, cordova.file.tempDirectory, "new_directory").then(function (success) {
    ...
    $scope.moveFile = function () {
      document.addEventListener('deviceready', function () {
        ...
        $cordovaFile.moveFile(cordova.file.externalRootDirectory, $scope.inputs.moveFile, cordova.file.tempDirectory, "new_file.txt").then(function (success) {
    ...
    $scope.copyDir = function () {
      document.addEventListener('deviceready', function () {
        ...
        $cordovaFile.copyDir(cordova.file.externalRootDirectory, $scope.inputs.copyDirectory, cordova.file.tempDirectory, "new_directory").then(function (success) {
    ...
    $scope.copyFile = function () {
      document.addEventListener('deviceready', function () {
        // path, fileName, newPath, newFileName
        $cordovaFile.copyFile(cordova.file.externalRootDirectory, $scope.inputs.copyFile, cordova.file.tempDirectory, "new_file.txt").then(function (success) {
